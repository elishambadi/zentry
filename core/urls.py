...
urlpatterns = [
    ...
    path('zenai/tasks/list/', views.task_chat_tasks, name='task_chat_tasks'),
    path('zenai/tasks/create/', views.task_chat_create, name='task_chat_create'),
    path('zenai/tasks/<int:task_id>/update/', views.task_chat_update, name='task_chat_update'),
    path('zenai/tasks/<int:task_id>/delete/', views.task_chat_delete, name='task_chat_delete'),
    path('zenai/tasks/<int:task_id>/toggle/', views.task_chat_toggle, name='task_chat_toggle'),
